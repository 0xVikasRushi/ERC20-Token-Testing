...
contract ERC20{
  ...
  string public asset="Reals Estate";
...
function transferTokenAsIssuer(address from, address to, uint256 value) public onlyIssuerOrRegistrar returns (bool) {    
    ...
    //require(!paused, "public transfer is paused");  -- should stay outcommented:  before kill, all token should be transfered to issuer wallet 
